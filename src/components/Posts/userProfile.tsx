...
import { EditProfileDialog } from "../Loyout/Edit-profile/edit"
    ...
    <Layout>
      {nUser && (
        <>
          ...
          {posts.filter(post => post.profile.id === nUser.user_id).map((post) => (
            <div className="max-w-4xl mx-auto bg-gray-100">
              <div className="relative">
                <img src={post.profile.portada_url || undefined} key={post.id}
              ...
              <div className="bg-white shadow">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="hidden sm:block md:hidden mt-6 min-w-0 flex-1">
                    <h1 className="text-2xl font-bold text-gray-900 truncate">{post.profile.display_name}</h1>
                  </div>
