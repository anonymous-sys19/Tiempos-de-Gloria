    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="lg:flex-1 bg-blue-600 flex flex-col items-center justify-center p-8">
        <div className="max-w-md text-center lg:text-left">
          ...
          />
          <h1 className="text-4xl lg:text-6xl font-bold text-white mb-4">Bienvenido</h1>
          <p className="text-xl text-blue-100">Conéctate con nosotros y descubre un mundo de posibilidades.</p>
        </div>
      </div>
