    ...
    return text.split("\n").map((line, index) => {
      if (line.startsWith("T:")) {
        ...
        return (
          <h2
            key={index}
            className="text-xl font-semibold mb-3 mt-4 text-gray-800"
          >
            {line.substring(2).trim()}
          </h2>
        );
              ...
              {isContributing ? (
                ...
                >
                  <div className="space-y-2">
                    <div
                      className={isExplanationOpen ? "hidden" : "line-clamp-3"}
                    >
                ...
                <p className="text-gray-500 italic">
                  No explanation available yet. Be the first to contribute!
                </p>
              )}
            </ScrollArea>
          </div>
