...
import { useAuth, UserData } from "@/data/hooks/userAuth";
    ...
    <div className="flex flex-col bg-gray-100 dark:bg-gray-900">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          ...
          } fixed md:translate-x-0 z-40 w-64 bg-white dark:bg-gray-800 shadow-md overflow-y-auto transition-transform duration-300 ease-in-out h-full`}
        >
          <nav className="mt-5 px-2 space-y-1">
            ...
            >
              ...
              <a
                href="/"
                className="flex w-full items-center justify-start dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700"
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56">
                ...
                <DropdownMenuItem>
                  ...
                  <a
                    href="explicaciones-biblicas"
                    className="dropdown-item-text"
                    onClick={handleNavigation}
                  >
                    Explicaciones Biblicas
                  </a>
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <StarFilledIcon className="mr-2 h-4 w-4" />
                  <a
                    href="/sermones-biblicos"
                    className="dropdown-item-text"
                    onClick={handleNavigation}
                  >
                    Sermones
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56">
                ...
                <DropdownMenuItem>
                  <Users className="mr-2 h-4 w-4" />
                  <a href="/declaracion-de-fe" className="dropdown-item-text">
                    Declaración de Fe
                  </a>
                </DropdownMenuItem>
                <DropdownMenuItem>
                ...
                <DropdownMenuItem>
                  <Users className="mr-2 h-4 w-4" />
                  <a href="/estructura" className="dropdown-item-text">
                    Estructura
                  </a>
                </DropdownMenuItem>
              </DropdownMenuContent>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56">
                ...
                <DropdownMenuItem>
                  <Users className="mr-2 h-4 w-4" />
                  <a href="/un-buen-liderazgo" className="dropdown-item-text">
                    Se un lider
                  </a>
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <Users className="mr-2 h-4 w-4" />
                  <a href="" className="dropdown-item-text">
                    mas...
                  </a>
                </DropdownMenuItem>
                <DropdownMenuItem>
